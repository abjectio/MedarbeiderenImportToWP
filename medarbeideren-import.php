...
require_once( '/home/abjectio/koding/tmportal/web/wp-admin'. '/admin.php' );
...
//require_once( ABSPATH . 'wp-admin/includes/medarbeideren-import.php' );
...
<form method="get" action="medarbeideren-import.php">
	...
	<form action="medarbeideren-import.php" method="get">
